...
example.view.primary_color = goog.object.get(example.view.global$module$material_ui$colors.blue,(100));
example.view.primary_color_dota = "#e9463b";
example.view.custom_theme = example.view.global$module$material_ui$styles.createMuiTheme.call(null,({"palette": ({"primary": ({"main": example.view.primary_color_dota})})}));
example.view.custom_styles = (function example$view$custom_styles(theme){
return ({"button": ({"margin": theme.spacing.unit}), "textField": ({"width": (200), "marginLeft": theme.spacing.unit, "marginRight": theme.spacing.unit})});
});
example.view.with_custom_styles = example.view.global$module$material_ui$styles.withStyles.call(null,example.view.custom_styles);
example.view.active_demo = example.demos.demo_dota2_splash.view;
