...
goog.addDependency("../example/demos/demo_semi_carry.js", ['example.demos.demo_semi_carry'], ['material_ui', 'reagent.core', 'cljs.core', 'material_ui_icons']);
...
goog.addDependency("../example/demos/demo_dota2_splash.js", ['example.demos.demo_dota2_splash'], ['material_ui', 'reagent.core', 'cljs.core', 'material_ui_icons', 'reagent.impl.template', 'example.utils.http_fx']);
...
goog.addDependency("../example/routes.js", ['example.routes'], ['example.demos.demo_semi_carry', 'example.demos.demo_dota2_splash', 'example.demos.demo_soloist', 'example.demos.demo_hard_support', 'example.demos.demo_hard_carry', 'reagent.core', 'cljs.core', 'goog.history.EventType', 'example.events', 'goog.History', 'example.demos.demo_roaming_support', 'secretary.core', 'example.subs', 'goog.events', 're_frame.core', 'example.utils.http_fx']);
goog.addDependency("../example/components/sidebar.js", ['example.components.sidebar'], ['reagent.core', 'cljs.core', 'example.utils.http_fx']);
goog.addDependency("../example/view.js", ['example.view'], ['example.demos.demo_dota2_splash', 'material_ui', 'example.routes', 'material_ui.styles', 'reagent.core', 'cljs.core', 'material_ui_icons', 'goog.object', 'reagent.impl.template', 'material_ui.colors', 'example.components.sidebar', 're_frame.core', 'example.utils.http_fx']);
